                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="data.judul" disabled />
                                </div>

                                <div class="form-group">
                                    <label>Divisi</label>
                                    <input type="text" class="form-control" v-model="data.divisi" disabled />
                                </div>

                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input type="text" class="form-control" v-model="data.tanggal" disabled />
                                </div>

                                <div class="form-group">
                                    <label>Total Aset</label>
                                    <input type="text" class="form-control" v-model="data.total" disabled />
                                </div>

                                <div class="form-group">
                                    <label>Jumlah aset discan</label>
                                    <input type="text" class="form-control" v-model="data.scan" disabled />
                                </div>

                                <div class="form-group">
                                    <label>Jumlah aset belum discan</label>
                                    <input type="text" class="form-control" v-model="data.not" disabled />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <b-table striped hover bordered :items="asets.data" :fields="fields" show-empty>
                                        <template #cell(divisi)="data">
                                            <span class="badge badge-primary" v-if="data.item.divisi == 'IT Support'">IT
                                                Support</span>
                                            <span class="badge badge-success"
                                                v-else-if="data.item.divisi == 'Production'">Production</span>

                                            <span class="badge badge-warning"
                                                v-else-if="data.item.divisi == 'Finance'">Finance</span>
                                        ...
                                        <template #cell(status)="data">
                                            <span class="badge badge-success"
                                                v-if="data.item.status == 'baik'">OK</span>
                            ...
                            params: { id: row.item.qr },
                          }" type="button" class="btn btn-primary">Detail</router-link>
                                            </div>
                                        </template>
                                    </b-table>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="pull-right">
                                            <b-pagination v-model="page" :total-rows="asets.meta.total"
                                                :per-page="asets.meta.per_page" aria-controls="asets"
                                                v-if="asets.data && asets.data.length > 0"></b-pagination>
                                        </div>
                                    </div>
                                </div>
                            </div>
